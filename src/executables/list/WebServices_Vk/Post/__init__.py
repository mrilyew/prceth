...
class Implementation(BaseVkItemId):
    ...
    class Extractor(BaseVkItemId.Extractor):
        ...
        async def format_attachment(self, key, attachment, orig):
            ...
            attachment_representation = Representation.findByName(attachment_name)
            if attachment_representation == None:
                from executables.list.Data.Json import Implementation as UnknownAttachmentRepresentation
